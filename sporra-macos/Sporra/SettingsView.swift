...
struct SettingsView: View {
    ...
    private var serverSection: some View {
        Section {
            ...
            // "sporra.your-tailnet.ts.net" down the left of the row and put
            ...
            TextField("Server address", text: $draft,
                      prompt: Text("sporra.your-tailnet.ts.net"))
                .labelsHidden()
            ...
            if tracking.syncPhotos {
                ...
                if photos.isLimited {
                    ...
                    Button {
                        ...
                        Label("Photos are turned off for Sporra. Open System Settings to allow them.",
